...
export function getEtherscanLink(
  ...
  const prefix = `https://${ETHERSCAN_PREFIXES[chainId] || ETHERSCAN_PREFIXES[56]}${ETHERSCAN_LINKS[chainId] ||
    ETHERSCAN_LINKS[56]}`
...
// add 20%
export function calculateTwoGasMargin(value: BigNumber): BigNumber {
...
export function getUTCDate(time: number) {
