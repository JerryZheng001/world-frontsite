...
export function getUserNonce(params:any){ 
  return httpUrl.get("/api/user/get_nonce/",params)
}
//用户授权core
export function getUserToCore(params:any){ 
  return httpUrl.post("/api/user/login/",params)
}
...
export function getDetectAddressSubmit(data: any) {
  return httpUrl.post("/api/submit/", data)
}

//上传文件
export function getDetectFileUpload(data: any) {
  return httpUrl.post("/api/upload/", data)
}
...
export function getTestStatus(params:any){ 
  return httpUrl.get("/api/api/v1/check_status",params)
}

//历史记录

export function getHistoryLists(params:any){ 
  return httpUrl.get("/api/api/v1/history",params)
}

//检测记录总数

export function getListsTotal(){ 
  return httpUrl.get("/api/api/v1/total")
}
...
export function getTestResult(params:any){ 
  return httpUrl.get("/api/api/v1/details",params)
}

//下载文件
export function getFile(params:any){ 
  return httpUrl.get("/api/download/",params)
}